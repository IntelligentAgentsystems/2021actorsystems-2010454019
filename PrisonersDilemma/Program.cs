    ...
    Properties = new GameProperties[]
        {
           ...
           new GameProperties() {IdGame = "a-b", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(AlwaysDefectPlayer) },
           new GameProperties() {IdGame = "a-c", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(GradualPlayer) },
           new GameProperties() {IdGame = "a-d", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(MistrustPlayer) },
           new GameProperties() {IdGame = "a-e", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(PavlovPlayer) },
           new GameProperties() {IdGame = "a-f", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(ProberPlayer) },
           new GameProperties() {IdGame = "a-g", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(RandomPlayer) },
           new GameProperties() {IdGame = "a-h", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(SpitePlayer) },
           new GameProperties() {IdGame = "a-i", Rounds = rounds, Player1 = typeof(AlwaysCooperate),Player2 = typeof(TitForTatPlayer) },
